...
class TwitterOAuth {
  ...
  private $no_get_cache;
  /*Min*/
  public $cache_interval;
   ...
   */
  function __construct($consumer_key, $consumer_secret, $oauth_token = NULL, $oauth_token_secret = NULL, $path="", $cache_interval=15) {
  ...
  function get($url, $parameters = array()) 
  {
    ...
    { 
        if ( !empty($this->cache_interval) && !preg_match('/errors/', $response) )
        {
          if(is_writable($this->cache_dir) && $response) 
          {
